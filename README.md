...
| [`@ontrove/cli`](packages/trove-cli) | The `trove` command-line tool — a scriptable GraphQL client for your knowledge base and the toolchain for authoring sources and building & deploying toolkits. | `curl -fsSL https://ontrove.sh/install.sh \| sh` · [other channels](packages/trove-cli#install) |
