...
- b547741: A toolkit's manifest is reachable from the compiled server, and `visibility`
...
- b547741: A toolkit can declare a connection Trove holds for it, instead of holding an
...
- b784a6e: A toolkit's manifest is reachable from the compiled server, and `visibility`
  is spelled the way it is stored.
