...
- 1c41a62: `extension.ts` is the entry filename for both extension kinds, and `init`
  scaffolds it.
...
- @ontrove/extend@4.1.0

## 4.0.0

### Major Changes

- e33fc72: **Breaking: `trove mcp <…>` is now `trove toolkit <…>`.** No alias — the old
...
deploy` alongside it, a bare `deploy` silently meaning _toolkit_ was a coin
...
- Updated dependencies [220ba39]
- Updated dependencies [4c7303a]
  - @ontrove/extend@3.3.0

## 3.2.0

### Patch Changes

- Updated dependencies [c9a89cd]
  - @ontrove/extend@3.2.0
...
- Updated dependencies [55793b0]
  - @ontrove/extend@3.0.0

## 2.0.1

### Patch Changes

- 7048693: `@ontrove/cli` depended on `@ontrove/extend` as `workspace:*`, which is a
...
- Updated dependencies [b9e04d4]
  - @ontrove/extend@2.0.0
