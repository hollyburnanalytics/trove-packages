...
import { flag, flagList, intFlag, type ParsedArgs } from '../lib/args.js';
...
function formatSearchResults(ctx: CommandContext, results: SearchResults): string {
...
function formatDocumentList(ctx: CommandContext, docs: Document[]): string {
...
function emit(ctx: CommandContext, data: unknown, jsonlList: unknown, human: string): void {
...
function formatDocument(ctx: CommandContext, doc: Document): string {
